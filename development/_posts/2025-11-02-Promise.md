...
classes: wide
header:
    teaser: ../../assets/images/development/dev_03_1.png
---
...
fulfilled : ```promise.then(func)```을 호출했을 때, ```func```를 가능한 빨리 호출하는 상태<br/>
rejected : ```promise.then(func,r)```을 호출했을 때, ```r```를 가능한 빨리 호출하는 상태<br/>
